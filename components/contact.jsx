...
export const Contact = () => (
  <section id="contact" className="relative px-6 py-32 lg:py-40 cv-auto">
    ...
    <div className="mx-auto max-w-2xl text-center">
      ...
      <FadeIn delay={0.1}>
        <h2 className="mt-6 font-heading text-4xl font-bold text-content sm:text-5xl lg:text-6xl">
          Say Hello
        </h2>
      </FadeIn>
      ...
      <FadeIn delay={0.3}>
        <div className="mt-10 flex justify-center">
          <a
            ...
            className="group inline-flex items-center gap-3 rounded-full border border-accent/20 bg-accent/[0.04] pl-7 pr-2 py-2 font-mono text-sm text-accent transition-all duration-500 hover:border-accent/45 hover:bg-accent/[0.08] active:scale-[0.98] cursor-pointer"
            style={{ transitionTimingFunction: "cubic-bezier(0.32,0.72,0,1)" }}
          >
            Write to me
            {/* Nested icon pill */}
            <span
              className="flex h-9 w-9 items-center justify-center rounded-full bg-accent/10 transition-all duration-500 group-hover:bg-accent/20 group-hover:scale-105 group-hover:translate-x-0.5 group-hover:-translate-y-px"
              style={{ transitionTimingFunction: "cubic-bezier(0.32,0.72,0,1)" }}
              aria-hidden="true"
            >
